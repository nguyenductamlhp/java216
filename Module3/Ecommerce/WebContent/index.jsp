    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="index.jsp"><span>Electronics</span></a></h1>
                    </div>
                </div>
...
<%--                                     	SingleProductServlet?txtProduct=<%= %> --%>
                                		</div>
                           		</div>
                            
                          		<h2><a href="single-product.jsp"><%=product.getName() %></a></h2>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        %>
                            ...
                            <a href="single-product.jsp"><img src="<%=product.getImageLink() %>" alt="" class="product-thumb"></a>
                            <h2><a href="single-product.jsp"><%=product.getName() %></a></h2>
                            ...
                            <div class="product-wid-price">
                                <ins>$<%=product.getPrice() %>000</ins> <del>$<%=product.getPrice_promotion() %>000</del>
                            </div>                            
                        </div>
                        <%
                        }
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        %>
                        	<div class="single-wid-product">
                            <a href="single-product.html"><img src="<%=product.getImageLink() %>" alt="" class="product-thumb"></a>
